...
def generate_index_html(folder):
    ...
    for name in sorted(os.listdir(folder)):
        ...
        if os.path.isdir(full_path):
            items.append(
                f'<li><a href="{name}"><i class="fa-solid fa-folder"></i>&nbsp;&nbsp;{name}/</a></li>'
            )
        else:
            items.append(f'''
<li>
...
<head>
  ...
  <link rel="icon" href="https://raw.githubusercontent.com/YuheshPandian/_Reference/f6f4c3ed273ff3ec6a10d1dfaa64e004dafc5411/images/logo.svg
" type="image/svg+xml">
  <style>
